        ...
        <div class="w-full" style="max-width:380px;">
            ...
            <div class="fade-up" style="margin-bottom:20px;">
                ...
                <p class="text-sm mt-1.5" style="color:rgba(14,12,10,0.45);">
                    Créez votre compte instantanément en 1 clic.
                </p>
            </div>

            {{-- Option prioritaire : Google OAuth --}}
            <div class="fade-up-2">
                <a href="{{ route('social.redirect', 'google') }}"
                   class="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-xl text-sm font-semibold border transition-all duration-200 shadow-sm"
                   style="border-color: rgba(200,136,58,0.35); background: white; color: #0e0c0a;"
                   onmouseover="this.style.backgroundColor='#f5f0e8'; this.style.borderColor='#c8883a'"
                   onmouseout="this.style.backgroundColor='white'; this.style.borderColor='rgba(200,136,58,0.35)'">
            ...
            {{-- Séparateur --}}
            <div class="fade-up-2 flex items-center gap-3 my-4">
            ...
            <p class="text-center text-xs fade-up-3" style="color:rgba(14,12,10,0.35); margin-top:20px;">
                Déjà un compte ?
                <a href="{{ route('login') }}" wire:navigate
